<body id="page-top">
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#perhitunganAHP" aria-expanded="true" aria-controls="perhitunganAHP">
                    <i class="fas fa-fw fa-wrench"></i>
                    <span>Perhitungan AHP</span>
                </a>
                <div id="perhitunganAHP" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Rincian Perhitungan:</h6>
                        <a class="collapse-item" href="<?php echo site_url('auth/tampilIntegritas') ?>">Integritas</a>
                        <a class="collapse-item" href="<?php echo site_url('auth/PerbandinganBerpasanagn') ?>">Perhitungan Bobot</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#perhitunganTOPSIS" aria-expanded="true" aria-controls="perhitunganTOPSIS">
                    <i class="fas fa-fw fa-wrench"></i>
                    <span>Perhitungan Topsis</span>
                </a>
                <div id="perhitunganTOPSIS" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Rincian Perhitungan:</h6>
